...
int main(int argv, char **args) {
  ...
  float dt;
  // Cube points
  vector<Point3d> points = {Point3d(400, 400, 400), Point3d(600, 400, 400),
                            Point3d(600, 600, 400), Point3d(400, 600, 400),
                            Point3d(400, 400, 600), Point3d(600, 400, 600),
                            Point3d(600, 600, 600), Point3d(400, 600, 600)};

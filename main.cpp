...
//                     Point3d p1 = Point3d(l.x1, l.y1, l.z1);
//                     Point3d p2 = Point3d(l.x2, l.y2, l.z2);
//                     p1.rotate(axis,Point3d(0+xOrigin,
//                     0+yOrigin, 1.5+zOrigin),angle);
//                     p2.rotate(axis,Point3d(0+xOrigin,
//                     0+yOrigin, 1.5+zOrigin),angle); l = Line(p1.x, p1.y,
//                     p2.x, p2.y, RED, p1.z, p2.z);
//
//                 }
//                 trig = Triangle(edges[0],edges[1],edges[2]);
//     }
...
//         rotateTriangles(trigs,x, 1.5708 * dt); c.clear(); start =
//         SDL_GetTicks(); dt = (start - last) / 1000.f; last = start; if (dt >
//         0.0)
//         {
//
//             for(Triangle& trig: trigs){
...
//                     Point3d p1 = Point3d(l.x1, l.y1, l.z1);
//                     Point3d p2 = Point3d(l.x2, l.y2, l.z2);
//                     p1.rotate(y, Point3d(0+xOrigin, 0+yOrigin, 1.5+zOrigin),
//                     0.25 * 3.14 * dt); p2.rotate(y, Point3d(0+xOrigin,
//                     0+yOrigin, 1.5+zOrigin), 0.25 * 3.14 * dt); l.x1 = p1.x;
//                     l.x2 = p2.x;
//                     l.y1 = p1.y;
//                     l.y2 = p2.y;
//                     l = Line(p1.x, p1.y, p2.x, p2.y, RED, p1.z, p2.z);
...
//
//                 trig = Triangle(edges[0],edges[1],edges[2]);
//                 Triangle trigProjected = Triangle(project_line( edges[0]
//                 ),project_line( edges[1] ),project_line( edges[2] ));
